...
""" Our method """
def ramAndCot_first_graph_search(problem):
    return graph_search(problem, sortFringe())

""" Our heuristic method """
def ramAndCotHeur_first_graph_search(problem):
    return graph_search(problem, sortFringeHeur(problem))

def getExpandedNodes(problem):
    expandedNodes = [sortFringe().nExpandidos, sortFringeHeur(problem).nExpandidos]
