...
class sortFringe(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        self.A.sort(key=lambda n: n.path_cost)
        sortFringe.nExpandidos = sortFringe.nExpandidos + 1
...
class sortFringeHeur(Queue):
    ...
    def extend(self, items):
        self.A.extend(items)
        self.A.sort(key=lambda n: n.path_cost + self.problem.h(n))
        sortFringeHeur.nExpandidos = sortFringeHeur.nExpandidos + 1
